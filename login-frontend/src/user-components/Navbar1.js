...
import Individual from "./Individualstudent";
      ...
      <div className="App container-fluid">
        <Router>
                ...
                <Nav navbar>
                  ...
                  <NavItem>
                    <NavLink
                      ...
                      style={{ color: "lightgreen" }}
                    >
                      <span class="fa fa-home fa-lg"></span>&nbsp;Individual
                    </NavLink>
                  </NavItem>
                  <NavItem>
                    <NavLink
          ...
          <Switch>
            ...
            <Route exact path="/Individual"><Individual login={this.props.value}/></Route>
